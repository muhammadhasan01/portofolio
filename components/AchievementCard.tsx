  ...
  return (
    <div>
      <div className='my-1 grid grid-cols-12 flex flex-col items-center justify-left'>
        ...
        <span dangerouslySetInnerHTML={createMarkup()} className='font-bold font-montserrat text-medium -ml-3 lg:-ml-7 col-span-10' />
      </div>
      <div className='md:text-lg flex justify-left items-center'>
        <span className='font-semibold text-base md:text-medium font-montserrat'>Issued by {issuedBy}</span>
      </div>
