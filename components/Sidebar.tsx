...
const Sidebar = () => {
  return (
    <div>
      ...
      {/*  Email Button */}
      <button
        className='bg-gradient-to-r from-green-400 to-blue-400 w-8/12 rounded-full py-2 px-5 text-white my-2'>Email Me
      </button>
      <button
        className='bg-gradient-to-r from-green-400 to-blue-400 w-8/12 rounded-full py-2 px-5 text-white my-2'>Toggle
        Theme
      </button>
    </div>
  );
